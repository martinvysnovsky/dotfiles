...
Use `TestBed.solitary()` from `@suites/unit` for all resolver and controller tests.
Use real database via Testcontainers for service/loader tests.

See `testing-nestjs` skill for complete patterns and examples (`unit-testing.md`).
